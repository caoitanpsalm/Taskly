...
$tasks = $con->query("SELECT * FROM tasks WHERE user_id = $user_id AND due_date > CURDATE() AND status != 'deleted' ORDER BY due_date ASC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Upcoming Tasks - Taskly</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-section">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="upcoming.php" class="active">
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <p>Your future tasks and deadlines</p>
        </div>
            ...
            <div class="task-list">
                    ...
                    <?php while($t = $tasks->fetch_assoc()): ?>
                        <div class="task-item">
                            ...
                            <div class="task-meta">
                                ...
                                <span class="meta-tag meta-status-<?php echo strtolower(str_replace(' ', '-', $t['status'])); ?>">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>You're all caught up! Add new tasks to see them here.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
